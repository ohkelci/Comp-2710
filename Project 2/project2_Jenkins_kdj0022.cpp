//  Kelci Jenkins
//  project2_Jenkins_kdj0022.cpp
//  Used class notes and slides to help.
//
...
/*
* Call by reference
* Strategy 1: Everyone shoots to kill the highest accuracy player alive * Input: B_alive indicates Bob is alive or dead
...
//Initializes Random number generator's seed and calls test functions
    cout << "*** Welcome to Kelci's Duel Simulator ***\n";
    srand(time_t(0));
...
for (int i = 0; i < TOTAL_RUNS; i++ ){
    ...
    while (at_least_two_alive(aaronAlive, bobAlive, charlieAlive)) {
        ...
        if (charlieAlive){
            Charlie_shoots(bobAlive, aaronAlive);
        }
